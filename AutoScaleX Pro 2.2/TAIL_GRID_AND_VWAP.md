...
Документ описывает поведение, согласованное с техническим заданием на хвост сетки и правила VWAP: когда что вызывается, пороги по открытым SELL, логи и настройки.
